...
public class JobService {
    ...
    public List<Job> getAllDishes() {return jobRepository.findAll();};
    //save a new job
    ...
    public List<Job> getFilteredJobs(String searchedTitle, String searchedLocation, Double searchedSalary){
        return jobRepository.findByIgnoreCaseTitleandLocationandSalary(searchedTitle, searchedLocation, searchedSalary);
    }
