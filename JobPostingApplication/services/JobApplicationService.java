...
public class JobApplicationService {
    ...
    public List<Application> getJobApplicationByJob(Long jobId) {
        return applicationRepository.findByJobId(jobId);
    }

    //Get job application by id
    public Optional<Application> getJobApplicationById(Long id) {
        return applicationRepository.findById(id);
    }

    //Update an existing job application
    public Application updateJobApplication(Long id, Application updatedApplication) {
    ...
    public int deleteJobApplicationById(Long id) {
